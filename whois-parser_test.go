...
func TestWhoisParser(t *testing.T) {
	...
	for _, v := range dirs {
		...
		if domain_ext != "museum" && domain_ext != "at" && domain_ext != "int" && domain != "jisc.ac.uk" {
		...
		if domain_ext != "at" && domain_ext != "kr" && domain_ext != "int" && domain != "jisc.ac.uk" {
		...
		if domain_ext != "cn" && domain_ext != "ru" && domain_ext != "su" && domain_ext != "hk" && domain != "jisc.ac.uk" {
