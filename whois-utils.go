...
func TransferName(name string) string {
	...
	name = strings.Replace(name, "servers", "name server", -1)
	...
	name = strings.Replace(name, "entry create", "create", -1)
	...
	name = strings.Replace(name, "entry update", "update", -1)
	...
	name = strings.Replace(name, "renewal date", "expire", -1)
